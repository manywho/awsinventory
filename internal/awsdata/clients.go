...
type Clients interface {
	...
	GetCloudFormationClient(region string) cloudformationiface.CloudFormationAPI
}
...
func (c DefaultClients) GetCloudFormationClient(region string) cloudformationiface.CloudFormationAPI {
